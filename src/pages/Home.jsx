          ...
          <div className="section-container relative">
            <div className="max-w-4xl">
              <div className="grid grid-cols-2 sm:flex sm:flex-wrap gap-3 mb-6">
                <span className="inline-block text-center px-3 sm:px-4 py-2 bg-dark-card border border-primary-500/30 text-primary-500 text-xs sm:text-sm font-medium rounded-full backdrop-blur-sm">
